...
/////////////////////////////////////////////////////////////////////////// -- OTHER -- //////////////////////////////////////////////////////////////////////////////////
                ...
                else if (variableName == "cost_threshold") {
                    this->costThreshold = std::stod(variableValue);
                }
                else if (variableName == "coast_threshold") {
                    this->coast_threshold = std::stod(variableValue);
                }
                else if (variableName == "posDominationTolerance") {
                ...
                else if (variableName == "posDominationThreshold") {
                    this->posDominationThreshold = std::stod(variableValue);
                }
                else if (variableName == "speedDominationThreshold") {
                    this->speedDominationThreshold = std::stod(variableValue);
                }
