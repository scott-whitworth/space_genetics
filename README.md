...
4. Output Resulting Files (### refers to the time_seed value used in the run)
  ...
  - referencePoints-###.csv: Prints the coordinates of all of the created reference points for the run. SHOULD THEY BE CREATED FOR RANK DISTANCE?
...
Here is how the impact, rendezvous, and orbital data was obtained to be used in the asteroid config files. DO WE WANT THIS FOR PSYCHE?
...
4.  Using [impactParams.m](Matlab_PostProcessing/impactParams.m), DerivingImpactValues.xlsx DO WE WANT THIS?, or some other equivalent method, convert the values to cylindrical coordinates with velocity values changed from AU/day to AU/s.
